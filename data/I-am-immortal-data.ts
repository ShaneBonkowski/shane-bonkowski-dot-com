...
And so have you.`,
    ...
    {
      content: `
I’ve come to realize I abhor the word <em>Death</em>. Who are you to deny our greatness with that term? <em>Death</em>. You and I, we’re the lucky ones. We lucky few, through sheer determination and the right string of collisions, find ourselves with the gift of <em>Life</em>. The most precious stage of all cosmic transformations. We get the opportunity to think, to speak, to write, to love deeply, to witness it all.`,
      fontStyle: "normal",
      textAlign: "justify",
    },
    {
