...
const storyMetadata: WrittenContentMetadataProps = {
  ...
  contentImageUrl: "/webps/writing/the-sun.webp",
      ...
      <WrittenContentLoader {...storyMetadata}>
        <WrittenContentParagraphGroup>
          ...
          >
            ...
            spread their pollen across the fields. Among the treetops, the crows
            glide silently between the branches. Their dark feathers contrast
            against my pale light filtering through the leaves like black stars,
            bringing with them the passion of the night sky. In the symphony
          ...
          >
            ...
            their days fortifying their nests, having seen the horrors that late
            spring can bring. Others spend most of their time singing their
            lustful songs and shimmering with their colorful displays, eager to
            win over a mate. As spring grows older, the nests spread from
          ...
          >
            ...
            monolithic wings, clinging to their partners and the future they
            protect together. The rain will pour down from the sky like the
            oceans that cover this beautiful realm, pelting the birds like
            artillery shells. The same wind they use to soar among the clouds
