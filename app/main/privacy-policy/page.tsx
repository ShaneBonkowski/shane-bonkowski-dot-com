export default function Page() {
  return (
    <div
      ...
      id={"privacy-policy"}
      aria-label={`Page content for 'privacy-policy'`}
    >
      ...
      <p>
        ...
        policies regarding data handling and privacy. Not all mentioned
        scenarios or processes may be currently implemented, but could be in the
        future.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          Application refers to Better Boids, Flip Tile, and any other game
          contained on this Website.
        </li>
        <li>
          Company (referred to as either &quot;the Company&quot;,
          &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement)
          refers to Shanes Games.
        </li>
        <li>
        ...
        <li>
          Website refers to{" "}
          <a href="https://shanebonkowski.com">Shanes Games</a>.{" "}
        </li>
        <li>
      ...
      <p>
        ...
        <a href="/main/cookie-policy">Cookies Policy</a> or the Cookies section
