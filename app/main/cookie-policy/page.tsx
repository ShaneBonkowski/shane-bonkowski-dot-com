export default function Page() {
  return (
    <div
      ...
      id={"cookie-policy"}
      aria-label={`Page content for 'cookie-policy'`}
    >
      <h1>Cookie Policy</h1>
      <p>
        This Cookie Policy explains how Shanes Games (&quot;Company,&quot;
        &quot;We,&quot; &quot;Us,&quot; and &quot;Our&quot;) uses cookies and
        similar technologies to recognize you when you visit our website at{" "}
        <a href="https://shanebonkowski.com">https://shanebonkowski.com</a>{" "}
      ...
      <p>
        Disclaimer: the following document outlines the general practices and
        policies regarding cookies. Not all mentioned scenarios, cookies, or
        processes may be currently implemented, but could be in the future.
      </p>
      ...
      <p>
        Cookies set by the website owner (in this case, Shanes Games) are called
      ...
      <p>
        ...
        controls vary from browser to browser, you should visit your browsers
      ...
      <p>By email: 3ravens3@gmail.com</p>
    </div>
  );
}
